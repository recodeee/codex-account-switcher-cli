...
- [x] 1.1 Define end-to-end validation matrix for `plans-live-execution-observer`
...
- [x] [V1] DONE - Verification suite green (backend integration + frontend integration/component + lint + typecheck + OpenSpec validation)
