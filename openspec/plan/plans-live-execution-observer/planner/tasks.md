...
- [x] 1.1 Define planning principles, decision drivers, and viable options for `plans-live-execution-observer`
...
- [x] [P1] DONE - Final RALPLAN draft approved with resume-state persistence for account/runtime error recovery
