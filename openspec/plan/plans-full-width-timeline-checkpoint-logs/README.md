# Plan Workspace: plans-full-width-timeline-checkpoint-logs
...
Each role folder contains `tasks.md` with visible Spec / Tests / Implementation / Checkpoints checklists.
