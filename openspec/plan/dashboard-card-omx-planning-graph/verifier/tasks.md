...
- [x] 1.1 Define end-to-end validation matrix for `dashboard-card-omx-planning-graph`
...
- [x] [V1] DONE - Focused tests/lint/typecheck and OpenSpec validation completed green
