...
- [x] 1.1 Define planning principles, decision drivers, and viable options for `dashboard-card-omx-planning-graph`
...
- [x] [P1] DONE - Initial planning draft completed and execution lanes published
