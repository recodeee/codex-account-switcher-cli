...
- [x] 1.1 Define planning principles, decision drivers, and viable options for `dashboard-live-usage-websocket`
...
- [x] [P1] READY - Initial planning draft checkpoint
- [x] [P2] READY - Review loop checkpoint (architect/critic)
