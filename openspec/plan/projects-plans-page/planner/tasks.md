...
- [x] 1.1 Define planning principles, decision drivers, and viable options for `projects-plans-page`
...
- [x] [P1] DONE - Initial planning draft integrated Architect/Critic guidance and published execution handoff
