...
> By default we do **not** publish host port `1455` so `codex login` can keep using `127.0.0.1:1455`.
> In the dashboard, choose **Device code** for account sign-in in this default setup.
>
