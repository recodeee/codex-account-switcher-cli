...
def test_fallback_fingerprint_matching_updates_session_counts_without_overwriting_usage(
    ...
    monkeypatch.setattr(
        ...
        lambda: [
            ...
            _sample(used_percent=48.0, reset_at=1_717_000_200),
        ],
    )
